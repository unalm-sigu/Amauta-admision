...
import pe.edu.lamolina.amauta.controller.tramite.constanciaSolicitud.ConstanciaSolicitudServiceImp;
                ...
                for (String value : values) {
                    ...
                    switch (enums) {
                        ...
                        case CANTIDAD_CREDITOS_APROBADOS:
                            text = text.replace(enums.getValue(), alumnoCiclos.get(0).getCreditosAprobadosAcumulados().toString());
                            break;
