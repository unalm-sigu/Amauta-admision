...
public class GeneradorWordSolicitudServiceImp implements GeneradorWordSolicitudService {
                ...
                for (VariablePlantilla variablePlantilla : variables) {
                    ...
                    switch (enums) {
                        ...
                        case EPG_PROMEDIO_PONDERADO:
                            ...
                            text = text.replace(enums.getValue(), alumno.getPromedioAcumulado().setScale(2, RoundingMode.DOWN).toString());
    ...
    private void generarPromedioGraduacion(Egresado egresado, Alumno alumno) {
        ...
        BigDecimal ppg = sumNotasCreditos.divide(sumCreditos, 32, RoundingMode.DOWN);
        egresado.setPromedioGraduacion(ppg.setScale(2, RoundingMode.DOWN));
