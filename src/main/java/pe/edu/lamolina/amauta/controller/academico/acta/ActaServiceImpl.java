package pe.edu.lamolina.amauta.controller.academico.acta;
...
import pe.edu.lamolina.model.auditoria.ControlDeActasDet;
...
public class ActaServiceImpl implements ActaService {
    ...
    @Override
    public List<DocenteSeccion> allDocenteSeccionByFilter(Docente docente, Seccion seccion) {
        return docenteSeccionDAO.allByFilter(docente, seccion);
    }
