...
public interface AlumnosNivelacionService {
    ...
    List<AlumnoNivelacion> allAlumnosByDynatable(DynatableFilter filter, CicloAcademico ciclo, List<Carrera> carreras, String todo);

    AlumnosNivelacionResumen resumen(CicloAcademico ciclo, DataSessionPivot ds);
