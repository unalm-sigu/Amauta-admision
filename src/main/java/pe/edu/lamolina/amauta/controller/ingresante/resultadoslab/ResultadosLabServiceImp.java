...
import pe.edu.lamolina.amauta.dao.laboratorio.DiarioLaboratorioDAO;
...
public class ResultadosLabServiceImp implements ResultadosLabService {
    ...
    public void saveLaboratorio(HistoriaLaboratorio laboratorio) {
        ...
        BigDecimal hemoglobina = valorMuestra.multiply(new BigDecimal(21)).divide(estandar, 2, RoundingMode.DOWN);
