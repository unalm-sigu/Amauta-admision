...
public class CargaAdicionalFactor2ServiceImp implements CargaAdicionalFactor2Service {
    ...
    @Override
    @Transactional
    public void save(Factor2CargaAdicional factor, DataSessionPivot ds) {
        if (factor.getCantidadFin() != null) {
            Assert.isTrue(factor.getCantidadFin() >= factor.getCantidadInicio(), "Intervalo no válido");
        }
        ...
        factor2CargaAdicionalDAO.save(factor);
    }
