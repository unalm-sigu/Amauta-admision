...
public class AlumnoCicloDAOH extends AbstractEasyDAO<AlumnoCiclo> implements AlumnoCicloDAO {
    ...
    @Override
    public List<AlumnoCiclo> allActivesOrdenMeritoByAlumnoAsc(Alumno alumno) {
        Octavia sql = Octavia.query()
                .from(AlumnoCiclo.class, "ac")
                .join("alumno alu", "cicloAcademico ca", "controlMeritoCiclo", "controlMeritoFacultad", "controlMeritoCarrera")
                .leftJoin("situacionInicio si", "situacionFinal sf", "userRegistro ur")
                .leftJoin("userModificacion um")
                .filter("alu.id", alumno)
                .filter("ac.estado", EstadoMatriculaEnum.MAT.name())
    ...
    @Override
    public List<AlumnoCiclo> allRetiroCiclosByAlumno(Alumno alumno) {
        Octavia sql = Octavia.query()
                .from(AlumnoCiclo.class, "ac")
                .join("alumno alu", "cicloAcademico ca")
                .leftJoin("situacionInicio si", "situacionFinal sf")
                .filter("alu.id", alumno)
                .filter("ac.estado", EstadoMatriculaEnum.RCI);
        return all(sql);
    }

    @Override
    public List<AlumnoCiclo> allActivesOrdenMeritoByAlumnoAscCustom(Alumno alumno) {
        Octavia sql = Octavia.query()
                .from(AlumnoCiclo.class, "ac")
                .join("alumno alu", "cicloAcademico ca", "controlMeritoCiclo", "controlMeritoFacultad")
                .left("controlMeritoCarrera")
                .leftJoin("situacionInicio si", "situacionFinal sf", "userRegistro ur")
                .leftJoin("userModificacion um")
                .filter("alu.id", alumno)
                .filter("ac.estado", EstadoMatriculaEnum.MAT.name())
