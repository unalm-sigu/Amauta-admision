...
public interface DocenteSeccionDAO extends EasyDAO<DocenteSeccion> {
    ...
    List<DocenteSeccion> allByCicloAula(CicloAcademico ciclo, Aula aula, OficinaEnum oficinaEnum, EstadoEnum... estadoEnum);
    ...
    List<DocenteSeccion> allActivosByDocentesCicloCodigo(List<Docente> docentes, CicloAcademico cicloAcademico);

    public List<DocenteSeccion> allActivosByDocentesCiclosCodigo(List<Docente> docentes, List<CicloAcademico> cicloAcademicos);

    DocenteSeccion findBySeccion(Seccion seccion, CicloAcademico cicloAcademico);
