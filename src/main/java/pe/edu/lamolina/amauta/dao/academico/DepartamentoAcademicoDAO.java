...
import pe.edu.lamolina.amauta.controller.academico.departamento.DepartamentoCursoDocente;
...
public interface DepartamentoAcademicoDAO extends EasyDAO<DepartamentoAcademico> {
    ...
    List<DepartamentoAcademico> allDynatableFilter(DynatableFilter filter);
