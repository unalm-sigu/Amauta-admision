...
public interface AlumnoCicloDAO extends EasyDAO<AlumnoCiclo> {
    ...
    List<MatriculaPreBean> allmatriculadosPregrado(CicloAcademico cicloAcademico, ModalidadEstudio modalidadEstudio, String facultad);
    ...
    List<AlumnoCiclo> allByAlumnosReg(List<Alumno> alumnos);
    ...
    List<AptoPreBean> allCandidadosAptosPregrado(CicloAcademico cicloAcademico, CicloAcademico cicloAnterior, ModalidadEstudio modalidadEstudio);

    List<AptoPreBean> allVotantesAptosPregrado(CicloAcademico cicloAcademico, ModalidadEstudio modalidadEstudio);

    Long countCiclosRegular(Alumno alumno);

    List<AlumnoCiclo> allByCicloAcademicoModalidadEstudio(CicloAcademico ciclo, ModalidadEstudioEnum modalidadEstudioEnum);

    List<AlumnoCiclo> allRetiroCiclosByAlumno(Alumno alumno);
