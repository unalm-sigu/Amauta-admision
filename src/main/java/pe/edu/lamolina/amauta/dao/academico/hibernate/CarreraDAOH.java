...
public class CarreraDAOH extends AbstractEasyDAO<Carrera> implements CarreraDAO {
    ...
    public List<Carrera> allPrePosGrado() {
        Octavia sql = Octavia.query()
                ...
                .join("modalidadEstudio me", "facultad fa")
                .leftJoin("areaPosgrado ap")
                .in("me.codigo", Arrays.asList(PRE, EPG, VIS, ESP))
                .orderBy("car.nombre");
    ...
    @Override
    public List<Carrera> allPreGrado() {
        Octavia sql = Octavia.query()
                .from(Carrera.class, "car")
                .join("modalidadEstudio me", "facultad fa")
                .filter("me.codigo", PRE)
    ...
    @Override
    public List<Carrera> allPosGrado() {
        Octavia sql = Octavia.query()
                .from(Carrera.class, "car")
                .join("modalidadEstudio me", "facultad fa")
                .leftJoin("areaPosgrado ap")
    ...
    @Override
    public List<Carrera> allCarrerasOfFacultadEconomia(Facultad facultad) {
        Octavia sql = Octavia.query()
                .from(Carrera.class, "car")
                .join("modalidadEstudio me", "facultad fa")
                .leftJoin("areaPosgrado ap")
