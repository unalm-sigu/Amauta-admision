...
public class AlumnoEvaluacionDAOH extends AbstractEasyDAO<AlumnoEvaluacion> implements AlumnoEvaluacionDAO {
    ...
    @Override
    public List<AlumnoEvaluacion> allByGrupoSeccion(List<GrupoSeccion> grupoSeccion) {
        Octavia sql = Octavia.query()
                .from(AlumnoEvaluacion.class, "aeva")
                .join("evaluacion eva", "eva.seccionResponsable sr", "sr.grupoSeccion gs")
                .in("gs.id", grupoSeccion);
