...
//                .complexFilter("concat(h.codigo,'-',d.id)", "in", hdias);
    ...
    public List<HorarioAula> allByCiclo(CicloAcademico cicloAcademico) {
        Octavia sql = Octavia.query()
                ...
                .left("seccion sec")
                .left("sec.grupoSeccion gs", "gs.cicloAcademico ca")
                .filter("ca.id", cicloAcademico)
                .orderBy("ha.fechaInicio");
    ...
    public List<HorarioAula> allByAulaFecha(Aula aulaFormFecha) {
        Octavia sql = Octavia.query()
                ...
                .left("ha.cursoMasivoExamen cme", "cme.curso curr")
                .left("ha.seccionGrupoEspecial sge", "sge.seccion")
                .left("ha.seccionGrupoRegular sgr", "sgr.seccion")
    ...
    @Override
    public void deleteCursosMasivosyRolExamenes(RolExamenes rolExamenes) {
        StringBuilder strb = new StringBuilder();
        strb.append(" delete from HorarioAula ha ");
        strb.append("  where ha.cursoMasivoExamen is not null ");
        strb.append("    and ha.rolExamenes.id = :ROLEX ");
    ...
    @Override
    public List<HorarioAula> allByFechas(Date fechainicio, Date fechafin) {
        Octavia sql = Octavia.query()
                .from(HorarioAula.class, "ha")
                .join("dia d", "hora h", "aula au")
                .left("au.oficinaSupervisora ofi")
    ...
    @Override
    public List<HorarioAula> allByFechaInicioTipoHorario(Date fechaInicio, TipoHorarioAulaEnum tipoEnum) {
        Octavia sql = Octavia.query()
                .from(HorarioAula.class, "ha")
                .join("dia", "hora", "aula", "seccion")
    ...
    @Override
    public List<HorarioAula> allByCursosNivelacion(List<CursoNivelacion> cursosNivelacion) {
        Octavia sql = Octavia.query()
                .from(HorarioAula.class, "ha")
    ...
    @Override
    public List<HorarioAula> allByCursoNivelacion(CursoNivelacion cursoNivelacion) {
        Octavia sql = Octavia.query()
                .from(HorarioAula.class, "ha")
                .join("dia dia", "hora hora", "aula aula", "cursoNivelacion cn")
                .filter("cn.id", cursoNivelacion);

        return all(sql);
    }

    @Override
    public List<HorarioAula> allByCursoNivelacionFecha(CursoNivelacion cursoNivelacion, Date fecha) {
        Octavia sql = Octavia.query()
                .from(HorarioAula.class, "ha")
                .join("dia dia", "hora hora", "aula aula", "cursoNivelacion cn")
                .filter("ha.fechaInicio", "<=", fecha)
                .filter("ha.fechaFin", ">=", fecha)
                .filter("cn.id", cursoNivelacion);
    ...
    @Override
    public List<HorarioAula> allByDocente(Docente docente, CicloAcademico ciclo) {
        Octavia sql = Octavia.query()
                .from(HorarioAula.class, "ha")
                .join("dia dia", "hora hora", "aula aula", "cursoNivelacion cn")
                .join("cn.docente doc", "cn.cursoCiclo cuci")
                .join("cuci.curso", "cuci.cicloAcademico ci")
