...
public class CicloAcademicoDAOH extends AbstractEasyDAO<CicloAcademico> implements CicloAcademicoDAO {
    ...
    @Override
    public CicloAcademico findAnterior(CicloAcademico ciclo) {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("modalidadEstudio me")
                .filter("codigo", "<", ciclo.getCodigo())
    ...
    @Override
    public CicloAcademico findActivoSubvenciones() {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("modalidadEstudio me")
                .filter("ca.estadoSubvenciones", ACT)
                .filter("me.codigo", ModalidadEstudioEnum.PRE);
    ...
    @Override
    public CicloAcademico find(CicloAcademico cicloAcademico, ModalidadEstudioEnum modalidadEnum) {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("modalidadEstudio me")
    ...
    @Override
    public CicloAcademico findVerBoletin(ModalidadEstudioEnum modalidadEnum) {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("modalidadEstudio me")
                .filter("me.codigo", modalidadEnum)
    ...
    @Override
    public List<CicloAcademico> allActivosRegularAnteriores(int ciclos, CicloAcademico ciclo) {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("modalidadEstudio me")
                .filter("tipo", REG)
    ...
    @Override
    public List<CicloAcademico> allMenorIgual(int ciclos, CicloAcademico ciclo) {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("modalidadEstudio me")
                .filter("ca.codigo", "<=", ciclo.getCodigo())
    ...
    @Override
    public CicloAcademico findByCodigoAndModalidad(String codigo, ModalidadEstudioEnum modalidadEstudioEnum) {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("ca.modalidadEstudio me")
                .filter("me.codigo", modalidadEstudioEnum.name())
    ...
    @Override
    public List<CicloAcademico> allUltimosByModalidadEnum(ModalidadEstudioEnum modalidadEstudioEnum, int cantidadCiclos) {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("ca.modalidadEstudio me")
                .in("ca.estado", Arrays.asList(ACT, CER, PEND, CFG))
    ...
    @Override
    public CicloAcademico findConfiguradoPregrado() {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("modalidadEstudio me")
                .filter("estado", CFG)
    ...
    @Override
    public CicloAcademico findActivoByModalidadEstudio(ModalidadEstudioEnum modalidadEnum) {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("modalidadEstudio me")
    ...
    public List<CicloAcademico> allPregradoByRangeCode(int codeInit, int codeEnd) {
        Octavia sql = Octavia.query()
                ...
                .join("modalidadEstudio me")
                .in("estado", Arrays.asList(ACT, CER, PEND, CFG))
                .filter("codigo", ">=", codeInit)
                .filter("codigo", "<=", codeEnd)
                .filter("tipo", TipoCicloEnum.REG)
                .filter("me.codigo", ModalidadEstudioEnum.PRE)
                .orderBy("ca.year DESC", "ca.numeroCiclo DESC");
    ...
    @Override
    public List<CicloAcademico> allMenorRegularPreByCantidad(int maxResultado, CicloAcademico cicloAcademico) {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("modalidadEstudio me")
                .filter("me.codigo", PRE)
    ...
    @Override
    public List<CicloAcademico> allByYearModalidadEnum(int year, ModalidadEstudioEnum modalidadEnum) {
        Octavia sql = Octavia.query()
                .from(CicloAcademico.class, "ca")
                .join("modalidadEstudio me")
                .filter("me.codigo", modalidadEnum)
