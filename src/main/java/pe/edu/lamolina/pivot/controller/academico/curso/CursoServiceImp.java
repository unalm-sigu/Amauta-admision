...
public class CursoServiceImp implements CursoService {
    ...
    private void saveCurso(Curso curso) {
        ...
        curso.setEstado(EstadoEnum.CRE.name());
    ...
    private void updateCurso(Curso curso, Long[] idIdioma, String[] nombreIdioma, Usuario usuario) {
        ...
        cursoBD.setTipoCredito(curso.getTipoCredito());
    ...
    public String getCodigo(Curso curso) {
        ...
        String curCodFacultad = dpto.getFacultad().getCurCodigo();

        codigo = curCodFacultad + curso.getNivel();
