...
public interface UpdateHistorialAcademicoService {
    ...
    void updateTramiteDocumentoAcademico(TramiteDocumentoAcademico solicitudConstanciaForm, DataSessionMaipi ds);
    ...
    void saveTramiteDocumentoAcademico(TramiteDocumentoAcademico tramiteDocumentoAcademico, DataSessionMaipi ds);
