...
public interface HorarioAulaDAO extends EasyDAO<HorarioAula> {
    ...
    void deleteSeccionesEspecialesByRolExamenes(RolExamenes rolExamenes);
    ...
    List<HorarioAula> allByRangoFechaAulas(Date fechainicio, Date fechafin, List<Aula> aulas);
    ...
    List<HorarioAula> allByFechas(Date fechainicio, Date fechafin, Aula aula, TipoHorarioAulaEnum... tipoHorarioAulaEnum);
