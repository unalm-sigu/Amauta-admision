    ...
    methods: {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $(location).attr('href', APP.url("academico/tramiteacademico/historialalumno"));
                    } else {
        ...
        initFileupload: function () {
            ...
            $('#fileupload').fileupload({
                url: APP.url("academico/tramiteacademico/historialalumno/upload"),
                maxNumberOfFiles: 1,
                dataType: 'json',
                dropZone: '#upload',
                add: function (e, data) {
        ...
        avatarInit: function () {
            if ($('#avatar').val() !== "") {
                var ruta = $('#avatar').val();
                $('#imagenProfile').attr("src", APP.url("academico/tramiteacademico/historialalumno/view" + ruta));
            } else {
        ...
        buscarPersona: function () {
            ...
            $.ajax({                
                url: APP.url("academico/tramiteacademico/historialalumno/findPersonaAlumno"),
                type: 'POST',
                async: true,
                data: form.serialize(),
                success: function (response) {
                    if (response.success) {
                        ...
                        $("#nombreAlumno").text(data.paterno + " " + data.materno + ", " + data.nombres);
