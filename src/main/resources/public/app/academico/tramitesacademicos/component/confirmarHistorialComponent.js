...
Vue.component("conf-historial-component", {
    template: "#confirmarHistorialComponent",
    props: {
        alumno: {},
        tramite: {}
    },
    ...
    mounted() {
        if (this.alumno != null && this.alumno.id != null) {
            console.log("mounted confirmarHistorialComponent");
    ...
    methods: {
        ...
        cargaHistorial() {
            ...
            $.ajax({
                method: 'GET',
                url: APP.url('academico/tramiteacademico/' + $vue.tramite.id + '/' + $vue.alumno.id + '/historialAll'),
