$(function() {
    ...
    var Division = {
        ...
        reloadlist: function() {
            $.ajax({
                url: APP.url('academico/encuesta/editor/tema/list'),
                type: 'POST',
                async: true,
        ...
        tema: {
            ...
            save: function() {
                $.ajax({
                    url: APP.url('academico/encuesta/editor/tema/saveTema'),
                    type: 'POST',
                    async: false,
            ...
            update: function(e) {
                ...
                $.ajax({
                    url: APP.url('academico/encuesta/editor/tema/updateTema'),
                    type: 'POST',
                    async: true,
                    data: {id: tema},
                    success: function(response) {
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result) {
                            ...
                            $.ajax({
                                url: APP.url('academico/encuesta/editor/tema/deleteTema'),
                                type: 'POST',
                                async: true,
                                data: {id: menu},
                                success: function(response) {
        ...
        subTitulo: {
            ...
            save: function() {
                $.ajax({
                    url: APP.url('academico/encuesta/editor/tema/saveSubTitulo'),
                    type: 'POST',
                    async: false,
                    data: Division.form.serialize(),
                    success: function(response) {
            ...
            update: function(e) {
                ...
                $.ajax({
                    url: APP.url('academico/encuesta/editor/tema/updateSubTitulo'),
                    type: 'POST',
                    async: true,
                    data: {id: tema},
                    success: function(response) {
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result) {
                            ...
                            $.ajax({
                                url: APP.url('academico/encuesta/editor/tema/deleteSubTitulo'),
                                type: 'POST',
                                async: true,
                                data: {id: menu},
                                success: function(response) {
        ...
        bloque: {
            nuevo: function(e) {
                ...
                tinymce.init({
                    ...
                    images_upload_url: APP.url('academico/encuesta/editor/pregunta/upload'),
            ...
            save: function() {
                tinymce.triggerSave();
                $.ajax({
                    url: APP.url('academico/encuesta/editor/tema/saveBloque'),
                    type: 'POST',
                    async: false,
                    data: Division.form.serialize(),
                    success: function(response) {
            ...
            update: function(e) {
                ...
                $.ajax({
                    url: APP.url('academico/encuesta/editor/tema/updateBloque'),
                    type: 'POST',
                    async: false,
                    data: {id: tema},
                    success: function(response) {
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result) {
                            ...
                            $.ajax({
                                url: APP.url('academico/encuesta/editor/tema/deleteBloque'),
                                type: 'POST',
                                async: true,
                                data: {id: menu},
                                success: function(response) {
        ...
        itemSort: function(e) {
            ...
            $.ajax({
                url: APP.url('academico/encuesta/editor/tema/itemSort'),
                type: 'POST',
                async: false,
                data: postData,
                success: function(response) {
        ...
        estado: function(e) {
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        $.ajax({
                            url: APP.url('academico/encuesta/editor/tema/estado'),
                            type: 'POST',
                            async: false,
                            data: postData,
                            success: function(response) {
