        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr v-for="(cambioPlanCurricular , index) in resolucion.cambioPlanCurriculares" 
                    v-if="isCambioPlanCurricular &amp;&amp; validFilter(filterFacultad, cambioPlanCurricular)"> 
                    ...
                    <td>
                        <button v-on:click.prevent="del(index)" class="btn btn-danger" v-bind:disabled="isEdicion  &amp;&amp; cambioPlanCurricular.id != null">
...
<script>
    module.exports = {
        ...
        methods: {
            add() {
                let $vue = this;
                $vue.resolucion.cambioPlanCurriculares.push({seleccionado: true});
            },
            del(index) {
                let $vue = this;
