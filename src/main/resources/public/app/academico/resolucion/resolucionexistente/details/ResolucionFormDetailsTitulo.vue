    ...
    <div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr v-if="isTitulo &amp;&amp; validFilter(filterFacultad, titulo)" v-for="(titulo , index) in resolucion.tramiteTitulos">
                    ...
                    <td>
                        <button v-on:click="del(index)" class="btn btn-danger"  v-bind:disabled="isEdicion &amp;&amp; titulo.id != null">
