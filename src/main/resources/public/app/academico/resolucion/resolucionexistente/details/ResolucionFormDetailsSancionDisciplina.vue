...
<!--        <th class="col-sm-1 text-center"></th>-->
      ...
      <tr v-for="(sancionDsc , index) in resolucion.sancionDisciplina">
        <td class="v-middle text-center">
          <div class="form-group">
            <div class="col-md-12">
              <multiselect v-model="sancionDsc.alumno"
              ...
              <input v-model="sancionDsc.alumno" required="true" type="text" class="hide"/>
            </div>
          </div>
        </td>
<!--        <td class="v-middle">-->
