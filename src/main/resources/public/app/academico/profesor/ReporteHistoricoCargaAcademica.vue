<template>
    <div>
        ...
        <modal-simple ref="modalReporteHistoricoCargaAcademica"
                      v-bind="reporteHistoricoCargaAcademicaModal"
                      v-bind:okaction="downloadReporteHistoricoCargaAcademica">
            <div slot="header">
                <p class="h4 text-primary">Reporte Historico Carga Acádemica</p>
            </div>
            <div slot="body">
                <form  data-parsley-validate="true">
                    <div class="form-group m-b-xs">
                        ...
                        <input v-model="ciclo" required="true" type="text" class="hide"/>
                    </div>
    ...
    module.exports = {
        ...
        methods: {
            open() {
                ...
                vue.tipoGrado = null;
                vue.docente = null;
                vue.$refs.modalReporteHistoricoCargaAcademica.open();
            },
            downloadReporteHistoricoCargaAcademica() {
                let vue = this;
                let data = {
...
//                    tipoGrado: vue.tipoGrado ? vue.tipoGrado.id : '',
                ...
                console.dir(data);
//                return;
                axios_blob.post("/academico/profesor/reporteHistoricoCargaAcademica", data)
                        .then(response => {
                            UTIL_BLOB.save(response);
                            vue.$refs.modalReporteHistoricoCargaAcademica.close();
                        }, () => {
                            vue.$refs.modalReporteHistoricoCargaAcademica.stop();
