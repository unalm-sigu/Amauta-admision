<template>
    <div>
        ...
        <modal-simple ref="modalReporteCargaAcademica"
                      ...
                      v-bind:okaction="downloadReporteDocenteCicloAcademico">
            <div slot="header">
                <p class="h4 text-primary">Reporte Docente por Ciclo Académico</p>
            </div>
            <div slot="body">
...
<script>
    module.exports = {
        ...
        methods: {
            ...
            downloadReporteDocenteCicloAcademico() {
                let vue = this;
                let data = {
                ...
                axios_blob.post("/academico/profesor/reporteDocenteCicloAcademico", data)
                        .then(response => {
