$(function () {
    ...
    AlumnoVisitante = {
        ...
        numeroDNI: "",
        iniciar: function () {
            AlumnoVisitante.tipoDNI = $("#tipoDNI").val();
            AlumnoVisitante.numeroDNI = $("#numeroDocIdentidad").val();
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        AlumnoVisitante.modalViky.modal('hide');
        ...
        guardarPersona: function () {
            ...
            $.ajax({
                url: APP.url('academico/alumno/saveAlumnoVisitante'),
                type: 'POST',
                async: true,
                data: form.serialize(),
                success: function (response) {
        ...
        verificarPersona: function ($this) {
            ...
            if (user.val() != "" && perso.val() != "") {
                tipo.select2("val", AlumnoVisitante.tipoDNI);
                dni.val(AlumnoVisitante.numeroDNI);
            ...
            if (!(tipo.val() != "" && dni.val() != "")) {
                AlumnoVisitante.tipoDNI = tipo.val();
                AlumnoVisitante.numeroDNI = dni.val();
                return;
            }
