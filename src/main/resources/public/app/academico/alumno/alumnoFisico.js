$(function () {
    ...
    AlumnoFisico = {
        ...
        numeroDNI: "",
        iniciar: function () {
            AlumnoFisico.tipoDNI = $("#tipoDNI").val();
            AlumnoFisico.numeroDNI = $("#numeroDocIdentidad").val();
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        AlumnoFisico.modalViky.modal('hide');
        ...
        verificarPersona: function ($this) {
            ...
            if (user.val() != "" && perso.val() != "") {
                tipo.select2("val", AlumnoFisico.tipoDNI);
                dni.val(AlumnoFisico.numeroDNI);
            ...
            if (!(tipo.val() != "" && dni.val() != "")) {
                AlumnoFisico.tipoDNI = tipo.val();
                AlumnoFisico.numeroDNI = dni.val();
                return;
            }
