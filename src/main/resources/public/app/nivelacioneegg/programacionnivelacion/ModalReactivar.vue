<template>
    <modal-vik ref="modalReactivar"
               v-bind="modalReactivar"
               v-bind:okaction="saveReactivar">
        <div slot="body">
                    ...
                    <div class="row m-t">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Indique el motivo para reactivar esta sección</label>
    ...
    module.exports = {
        ...
        data() {
            return {
                ...
                form: "id-form-reactivar-seccion",
                title: "Reactivar sección cancelada",
                modalReactivar: VUE_MODAL.structFormAjax({
                    id: "id-modal-reactivar-seccion",
        ...
        methods: {
            ...
            saveReactivar() {
                ...
                myUtils.axios(VUE_AXIOS.structModalClose({
                    url: `/${rutaModulo}/changeEstado/R_ACT`,
                    modal: this.$refs.modalReactivar,
                    raptor: this.raptor,
                    body: payload
                }));
            },
            ...
            getModal() {
                return this.$refs.modalReactivar;
            },
