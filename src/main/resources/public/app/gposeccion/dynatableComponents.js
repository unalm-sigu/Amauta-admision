...
Vue.component("dynatable-especial-generico", {
    ...
    mounted: function () {
        ...
        $global.$on("seleccionarGrupoEspecialGenerico", function (grupoSel) {
        ...
        $global.$on("clearAndSelectEspGenerico", function () {
            $vue.clearAndSelect();
        });
...
Vue.component("dynatable-zeta-generico", {
    ...
    mounted: function () {
        ...
        $global.$on("seleccionarGrupoZetaGenerico", function (grupoSel) {
            if ($vue.dynatable != null && $vue.dynatable.queries != null) {
                $vue.dynatable.queries.add("search", grupoSel.codigo);
                $vue.dynatable.process();
            }
        ...
        $global.$on("clearAndSelectZetaGenerico", function () {
            $vue.clearAndSelect();
        });
