    ...
    module.exports = {
        ...
        data() {
            return {
                ...
                textarea: "id-textarea-sugerencias-informe",
                idModalConfirm: "id-modal-confirm-sugerencias-informe"
            };
        },
        methods: {
            iniciar() {
                this.sugerencias = this.informe.sugerencias;
                ...
                let config = VUE_MODAL.structConfirm({
                    ...
                    okaction: () => {
                        myUtils.axios(VUE_AXIOS.structModalClose({
                            ...
                            body: {id: this.informe.id, sugerencias: this.sugerencias}
            ...
            validar() {
                ...
                const ok = this.sugerencias == this.informe.sugerencias;
                if (!ok) {
