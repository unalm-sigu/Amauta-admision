<template>
    <div>
        <div>
            <h3 class="m-b-lg">Caracterización del Estudiante</h3>
            ...
            <form v-bind:id="form">
                <table class="table table-hover">
                    <thead>
                        <tr>
                            <th>Variable</th>
                            <th>Características del estudiante</th>
                        </tr>
                    </thead>
                    <tbody>
    ...
    module.exports = {
        ...
        data() {
            return {
                ...
                idModalConfirm: "id-modal-confirm-caracteristicas",
                datosAlumno: []
            };
        },
        mounted() {
        ...
        methods: {
            ...
            crearData() {
                ...
                for (let idx in this.tipos) {
                    ...
                    if (tipo.tipoCualidad === 'CARACTERISTICA') {
            ...
            saveDatos() {
                ...
                let config = VUE_MODAL.structConfirm({
                    ...
                    message: "¿Seguro que desea guardar las características del tutorado?",
                    okbtn: "Si, guardar",
                    okclass: "btn-primary",
                    okaction: () => {
