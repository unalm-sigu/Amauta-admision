$(function () {
    ...
    MenuForm = {
        ...
        ajaxPerfilMenu: function () {
            $.ajax({
                url: APP.url(`${rutaModulo}/perfiles`),
                type: 'POST',
                async: false,
        ...
        btnRolAsignar: function (e) {
            ...
            $.ajax({
                url: APP.url(`${rutaModulo}/asignarRol`),
                type: 'POST',
                async: false,
                data: form.serialize(),
                success: function (response) {
        ...
        btnRolDesasignar: function (e) {
            ...
            $.ajax({
                url: APP.url(`${rutaModulo}/desAsignarRol`),
                type: 'POST',
                async: false,
                data: form.serialize(),
                success: function (response) {
        ...
        itemUp: function (e) {
            ...
            //console.log('up');
            $.ajax({
                url: APP.url(`${rutaModulo}/itemMenuUp`),
                type: 'POST',
                async: false,
                data: {id: menu},
                success: function (response) {
        ...
        itemDown: function (e) {
            ...
            var menu = self.attr('rel');
            $.ajax({
                url: APP.url(`${rutaModulo}/itemMenuDown`),
                type: 'POST',
                async: false,
                data: {id: menu},
                success: function (response) {
